...
const { filtered, search, columns, openAdd, openEdit, deleteCategory, roomTypes, roomTypeFilter } = useAdminCategories()
...
<template>
  ...
  <AdminFilterBar v-model:search="search" placeholder="Tìm danh mục...">
    <select v-model="roomTypeFilter" class="filter-select" aria-label="Lọc theo loại phòng">
