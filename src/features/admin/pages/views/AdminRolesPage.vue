...
<template>
  <AdminPageHeader eyebrow="Bảo mật hệ thống" title-html="Vai trò <em>& Quyền hạn</em>" subtitle="Quản lý phân quyền động">
    <template #actions>
      <AppButton variant="unstyled" type="button" class="btn-add" @click="ui.openModal('addRole')"><AppIcon name="plus" :size="15" />Tạo vai trò mới</AppButton>
    </template>
  </AdminPageHeader>
  ...
  <div v-if="data" class="roles-container">
    <div class="tcard roles-table-card">
      <div class="tcard-header">
        ...
        <AppButton variant="unstyled" type="button" class="btn-add" style="font-size:11px;padding:5px 10px" @click="ui.openModal('addAdmin')">
        ...
        <div v-for="role in data.roles" :key="role.id" class="role-card">
          <div class="role-card-head">
            ...
            <div class="row-actions">
              <AppButton variant="unstyled" type="button" class="ra-btn ra-edit" @click="ui.openModal('editRole', role)"><AppIcon name="edit" :size="14" /></AppButton>
